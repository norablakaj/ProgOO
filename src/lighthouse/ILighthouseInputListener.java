...
/**
 * This Interface provides the methods to get user input through the
 * ProjektLighthouseAPI. These methods are called from the Projekt Lighthouse
 * receiving Thread!
 */
public interface ILighthouseInputListener {
     ...
     *
     * @param source a random number to identify the input device (multiple devices
     *               possible)
